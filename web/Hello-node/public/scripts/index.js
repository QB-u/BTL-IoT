  ...
  if (user) {
    ...
    dbRef
      ...
      .on("child_added", (snapshot) => {
        ...
        presElement.innerHTML = gas;
        updateElement.innerHTML = epochToDateTime(timestamp);

        // Display a warning message or take the desired action
        // For example, you can show a warning div on your HTML:
        // Add an HTML element for the warning message
        if (gas > 3000) {
          // Display a pop-up notification
          alert("KHI GAS VUOT QUA MUC AN TOAN 3000 !");
        }
      });
